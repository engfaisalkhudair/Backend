    ...
    <div class="card">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column" style="padding-bottom: 15px">
                <span class="card-label fw-bold fs-3 mb-1">  سلة المهملات  </span>
            </h3>
                ...
                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="#" class="btn btn-sm btn-light btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end"> نوع العملية
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{{ route("dress.restore" , ["id" => $itemdress->id]) }}" class="menu-link px-3">أسترجاع </a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                        ...
                        <div class="modal fade" id="exampleModal{{  $itemdress->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                            <div class="modal-content">
                                <form action="{{ route("dress.hdelete")}}" method="post">
                                    @csrf
                                    <input type="hidden" value="{{ $itemdress->id }}" name="id">
                                    {{-- <h1 class="modal-title fs-5" id="exampleModalLabel">Modal title</h1> --}}
                                    <div class="modal-body">
                                        هل أنت متاكد من حذف هذا الحجز بشكل نهائي !
                                    </div>
                                    <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">الغاء</button>
                                    <button type="submit" class="btn btn-primary"> حذف بشكل نهائي </button>
                    ...
                    @endforeach
                        ...
                        @else
                            لا يوجد أي حجز في سلة المهملات 
                        @endif
