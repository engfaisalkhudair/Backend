...
<head>
		...
		<link href="{{ asset("myDashboard/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css") }}" rel="stylesheet" type="text/css" />
		<link href="{{ asset("myDashboard/assets/plugins/custom/datatables/datatables.bundle.css") }}" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="page d-flex flex-row flex-column-fluid">
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between">
							...
							<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
								<a href="index.html" class="d-lg-none">
									<img alt="Logo" src="{{ asset("publicPage/image/1.png") }}" class="h-50px" />
								</a>
							</div>
							<!--end::Mobile logo-->
							<!--begin::Wrapper-->
								...
								<div class="d-flex align-items-stretch flex-shrink-0">
									...
									<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
										...
										<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
											...
											<div class="menu-item px-5" style="padding-top:10px;">
								...
								<div class="flex-shrink-0 me-2">
									<ul class="nav" role="tablist">
                                        <li class="nav-item" style="margin-left:30px" >
                                            <a href="{{ route('analytics') }}" style="width: 100%"  class="btn btn-sm btn-icon btn-color-warning btn-active-light btn-active-color-warning" >
                                            <!--begin::Svg Icon | path: icons/duotune/files/fil005.svg-->
                                            <span class="svg-icon svg-icon-2x" style="padding:5px;">
                                        ...
                                        <li class="nav-item" style="margin-left:30px" >
                                            <a href="{{ route('export') }}" style="width: 100%"  class="btn btn-sm btn-icon btn-color-danger btn-active-light btn-active-color-danger" >
                                            <!--begin::Svg Icon | path: icons/duotune/files/fil005.svg-->
                                            <span class="svg-icon svg-icon-2x" style="padding:5px;">
										...
										<li class="nav-item" style="margin-left:30px" >
                                            <a href="{{ route('dress.create') }}" style="width: 100%"  class="btn btn-sm btn-icon btn-color-primary btn-active-light btn-active-color-primary" >
											<!--begin::Svg Icon | path: icons/duotune/files/fil005.svg-->
										...
										<li class="nav-item" role="presentation">
                                            ...
                                            <button style="width: 100%;color :#50cd89;" type="button" class="btn btn-sm btn-icon  btn-active-light btn-active-color-primary"  data-bs-toggle="modal" data-bs-target="">
											<!--begin::Svg Icon | path: icons/duotune/files/fil005.svg-->
                                            <span class="svg-icon svg-icon-2x" style="color :#50cd89;">
												<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<!--begin::Footer-->
					<div class="footer py-4 d-flex flex-lg-column" style="position: relative;bottom: 0;" id="kt_footer">
						<!--begin::Container-->
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							<!--begin::Copyright-->
							<div class="text-dark order-2 order-md-1">
								<span class="text-muted fw-semibold me-1">2022&copy;</span>
								<a href="#" target="_blank" class="text-gray-800 text-hover-primary">Desgin By : Faisal Khudair</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Menu-->
								...
								<div data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="fv-row mb-10">
											...
											<!--End::Label-->
											<!--begin::Tagify-->
											<input class="form-control d-flex align-items-center" value="" id="kt_modal_create_campaign_location" data-kt-flags-path="/metronic8/demo6/assets/media/flags/" />
											<!--end::Tagify-->
										</div>
										<!--end::Input group-->
									</div>
		...
		<script src="{{ asset("myDashboard/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js") }}"></script>

		<!--end::Vendors Javascript-->
		<!--begin::Custom Javascript(used for this page only)-->
		<script src="{{ asset("myDashboard/assets/js/custom/utilities/modals/upgrade-plan.js") }}"></script>
		<script src="{{ asset("myDashboard/assets/js/custom/utilities/modals/create-campaign.js") }}"></script>
		<script src="{{ asset("myDashboard/assets/js/custom/utilities/modals/users-search.js") }}"></script>
...
<!-- Mirrored from preview.keenthemes.com/metronic8/demo6/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Oct 2022 08:57:24 GMT -->
</html>
