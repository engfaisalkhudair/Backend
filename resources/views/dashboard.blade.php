...
<!-- Mirrored from preview.keenthemes.com/metronic8/demo6/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Oct 2022 08:56:05 GMT -->
...
<head>
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="page d-flex flex-row flex-column-fluid">
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
								...
								<div class="d-flex align-items-stretch flex-shrink-0">
									...
									<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
										...
										<div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
											<img src="{{ asset("myDashboard/assets/media/avatars/300-4.jpg") }}" alt="image" />
										</div>
											...
											<div class="menu-item px-3">
												<div class="menu-content d-flex align-items-center px-3">
													...
													<div class="symbol symbol-50px me-5">
														<img alt="Logo" src="{{ asset("myDashboard/assets/media/avatars/300-4.jpg") }}" />
													</div>
													<!--end::Avatar-->
													<!--begin::Username-->
													<div class="d-flex flex-column">
					...
					<!--begin::Footer-->
					<div class="footer py-4 d-flex flex-lg-column" style="    position: fixed;width: 90%;right: 10%;bottom: 0;" id="kt_footer">
						<!--begin::Container-->
								...
								<div class="timeline-content mb-10 mt-n1">
									...
									<div class="overflow-auto pb-5">
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
											...
											<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
												<!--begin::Icon-->
												<img alt="/metronic8/demo6/../demo6/apps/projects/project.html" class="w-30px me-3" src="assets/media/svg/files/doc.svg" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-semibold">
													<!--begin::Desc-->
											...
											<div class="d-flex flex-aligns-center">
												<!--begin::Icon-->
												<img alt="/metronic8/demo6/../demo6/apps/projects/project.html" class="w-30px me-3" src="assets/media/svg/files/css.svg" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-semibold">
													<!--begin::Desc-->
		...
		<script src="{{ asset("myDashboard/assets/js/widgets.bundle.js") }}"></script>
		<script src="{{ asset("myDashboard/assets/js/custom/widgets.js") }}"></script>
		<script src="{{ asset("myDashboard/assets/js/custom/apps/chat/chat.js") }}"></script>
